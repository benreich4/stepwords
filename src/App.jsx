...
export default function App() {
  ...
  useEffect(() => {
    ...
    const onMainPuzzle = !isQuick && segments.length === 1 && segments[0] && !["admin","archives","create","explore","packs","privacy","stats","style-guide","submissions","terms","words"].includes(segments[0]);
